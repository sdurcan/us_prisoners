...
clf=DecisionTreeClassifier(criterion='entropy', max_depth=5,max_leaf_nodes=20, min_samples_leaf=10,min_samples_split=30)

selector=SelectKBest(k=50,score_func=mutual_info_classif)
clf=MLPClassifier(activation='identity', early_stopping=True,
...
#selector is a fitted scikit learn feature selector object
selector=SelectKBest(k=55,score_func=mutual_info_classif)
clf=LogisticRegression(max_iter=100000, n_jobs=8,solver='liblinear', verbose=True)
